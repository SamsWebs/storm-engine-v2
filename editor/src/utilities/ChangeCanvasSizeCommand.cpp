...
ChangeCanvasSizeCommand::ChangeCanvasSizeCommand(
    std::shared_ptr<class Canvas> &canvas, const int &prevCanvasWidth,
    const int &prevCanvasHeight)
    : mCanvas(canvas), mPrevCanvasWidth(prevCanvasWidth),
