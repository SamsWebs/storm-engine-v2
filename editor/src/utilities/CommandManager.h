...
public:
  ...
  /*
   *  If the mUndoStack is not empty, Calls the undo function for the command
   * that is on the top of mUndoStack. Pushes that command onto the Redo stack,
   * then pops the command off of the undo stack
   */
  void Undo();

  /*
   *  If the mRedoStack is not empty, Calls the redo function for the command
   * that is on the top of mRedoStack. Pushes that command onto the Undo stack,
   * then pops the command off of the undo stack
   */
  void Redo();
