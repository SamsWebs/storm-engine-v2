...
private:
  ...
  template <typename T> void Write(const T value, std::fstream &file);
...
public:
  ...
  */
  ...
  void WriteValue(TValue value, std::fstream &file, bool indent = false);
  template <typename TValue>
  void WriteWords(TValue value, std::fstream &file, bool indent = false);
  ...
  template <typename TKey, typename TValue>
  void WriteKeyAndValue(TKey key, TValue value, bool finalValue,
                        std::fstream &file);
  template <typename TKey, typename TValue>
  void WriteKeyAndUnquotedValue(TKey key, TValue value, std::fstream &file,
                                bool sameLine = false, bool lastValue = false);
  template <typename TKey, typename TValue>
...
template <typename TValue>
void LuaWriter::WriteUnquotedValue(TValue value, bool newLine,
                                   std::fstream &file) {
  if (newLine)
    PrepareNewValue(file);
...
template <typename TKey, typename TValue>
void LuaWriter::WriteQuotedKeyAndValue(TKey key, TValue value,
                                       std::fstream &file) {
  PrepareNewLine(file);
  Write('[', file);
...
template <typename TKey, typename TValue>
void LuaWriter::WriteKeyAndValue(TKey key, TValue value, bool finalValue,
                                 std::fstream &file) {
  // PrepareNewLine(file);
  Write(' ', file);
  Write(key, file);
...
template <typename TKey, typename TValue>
void LuaWriter::WriteKeyAndUnquotedValue(TKey key, TValue value,
                                         std::fstream &file, bool sameLine,
                                         bool lastValue) {
  if (!sameLine)
    PrepareNewLine(file);
...
template <typename TKey, typename TValue>
void LuaWriter::WriteKeyAndQuotedValue(TKey key, TValue value,
                                       std::fstream &file, bool finalValue) {
  PrepareNewLine(file);
  Write(key, file);
  Write(mMinimize ? "=" : " = ", file);
