...
//     pLevel =
//     levelParser.parseLevel(TheGame::Instance()->getLevelFiles()[TheGame::Instance()->getCurrentLevel()
//     - 1].c_str());

//     TheTextureManager::Instance()->load("bullet1.png", "bullet1",
//     TheGame::Instance()->getRenderer());
//     TheTextureManager::Instance()->load("bullet2.png", "bullet2",
//     TheGame::Instance()->getRenderer());
//     TheTextureManager::Instance()->load("bullet3.png", "bullet3",
//     TheGame::Instance()->getRenderer());
//     TheTextureManager::Instance()->load("lives.png", "lives",
//     TheGame::Instance()->getRenderer());
