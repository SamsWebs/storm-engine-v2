...
GameOverState::GameOverState(SDL_Renderer *renderer, int windowWidth,
                             ...
                             AssetStore *assetStore, GameStateMachine *machine, Gamepad *gamepad,
                             bool &isRunning, int finalScore, int wavesSurvived)
    : renderer_(renderer), windowWidth_(windowWidth),
      ...
      finalScore_(finalScore), wavesSurvived_(wavesSurvived) {}
