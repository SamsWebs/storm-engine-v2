...
// ─── Boards ───────────────────────────────────────────────────────────────────
// The walls are collider entities sitting just outside the ice, so the puck
// bounces off whatever it hits without the physics system knowing the rink
// layout. The left and right boards are split either side of the goal mouth,
// which is what leaves the mouth open for a shot to go in.
...
// ─── Gamepad ──────────────────────────────────────────────────────────────────
// Analog sticks rest slightly off centre, so anything under this counts as
// centred. ~24% of the Sint16 range, the usual starting point.
