...
void PlayState::LoadAssets() {
  assetStore_->AddTexture(renderer_, "tank-image",
                          "./assets/images/tank-panther-right.png");
  assetStore_->AddTexture(renderer_, "truck-image",
                          "./assets/images/truck-ford-right.png");
  assetStore_->AddTexture(renderer_, "tile-map",
                          "./assets/tilemaps/jungle.png");
  assetStore_->AddTexture(renderer_, "chopper-image",
                          "./assets/images/chopper.png");
  assetStore_->AddTexture(renderer_, "radar-image",
...
void PlayState::SpawnEntities() {
  ...
  chopper.AddComponent<AnimationComponent>(2, 15, false);
  ...
  radar.AddComponent<AnimationComponent>(8, 5, false);
