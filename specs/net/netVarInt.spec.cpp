...
Describe(NetVarIntSpec) {
    ...
    Describe(CanonicalEncodings) {
        It(should_reject_a_two_byte_encoding_of_a_one_byte_value) {
            ...
            Assert::That(NetVarIntUnpack(overlong, 2, value, consumed), Equals(false));
        };
        It(should_reject_a_five_byte_encoding_of_a_one_byte_value) {
            int32_t value = 0;
            int consumed = 0;
            uint8_t overlong[] = {0x81, 0x80, 0x80, 0x80, 0x00};
            Assert::That(NetVarIntUnpack(overlong, 5, value, consumed), Equals(false));
        };
        ...
        It(should_reject_bits_past_the_int32_payload) {
            ...
            Assert::That(NetVarIntUnpack(overflow, 5, value, consumed), Equals(false));
            uint8_t oneBitOver[] = {0x80, 0x80, 0x80, 0x80, 0x10};
            Assert::That(NetVarIntUnpack(oneBitOver, 5, value, consumed), Equals(false));
        };
